...
#endif
#include "wm8994_incall_boost.h"		// djp952: Incall volume boost settings
...
voodoo_hook_wm8994_pcm_probe(codec);
	...
	// djp952: Initialize the incall volume boost settings
	incall_boost_hook_wm8994_pcm_probe(codec);
